...
resource "kubernetes_secret" "cbd_app_kubernetes_secret" {
  ...
  data = {
    ...
    "Authentication__Google__ClientId" = data.azurerm_key_vault_secret.cbd_global_google_client_id.value
    "Authentication__Google__ClientSecret" = data.azurerm_key_vault_secret.cbd_global_google_client_secret.value
    "Authentication__Microsoft__ClientId" = data.azurerm_key_vault_secret.cbd_global_microsoft_client_id.value
    "Authentication__Microsoft__ClientSecret" = data.azurerm_key_vault_secret.cbd_global_microsoft_client_secret.value
